...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('disposition_receipts')) {
        ...
        if (! Schema::hasTable('governance_control_deliveries')) {
        ...
        if (! Schema::hasTable('governance_control_reviews')) {
            Schema::create('governance_control_reviews', function (Blueprint $table): void {
                ...
                $table->timestamps();
                $table->index(['tenant_id', 'source', 'resource_type', 'resource_id'], 'gov_review_resource_idx');
            });
        }

        if (! Schema::hasTable('processor_register_certifications')) {
            Schema::create('processor_register_certifications', function (Blueprint $table): void {
                ...
                $table->timestamp('decided_at');
                $table->timestamps();
                $table->index(['tenant_id', 'source', 'valid_until'], 'processor_cert_validity_idx');
            });
        }
    }
