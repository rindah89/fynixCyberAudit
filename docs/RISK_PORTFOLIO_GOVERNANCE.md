...
The enterprise foundation does not provide stochastic/Monte Carlo simulation, calibrated probability distributions, correlation modeling, capital modeling, or quantitative loss distributions. The operational foundation does not ingest loss events or KRI observations automatically and does not provide external KRI feeds, process telemetry, control indicators, currency conversion, statistical loss modeling, or capital calculations. The technology foundation does not discover assets, vulnerabilities, threats, or control telemetry. Treatment issues use the separately documented governed remediation and independent-closure workflow with separately required content-hashed accepted audit evidence. No risk domain automatically collects review evidence, validates evidence authenticity or sufficiency, infers decisions from file content, executes remediation, or closes issues from task state alone. Third-party risk uses its separately documented workflow.
