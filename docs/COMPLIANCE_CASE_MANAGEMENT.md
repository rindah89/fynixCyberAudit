...
- This slice does not provide anonymous/public hotline intake, email ingestion, legal-hold/eDiscovery, interview management, automatic remediation execution, external notification, regulatory reporting, qualified signatures, or investigation analytics. Remediation tasks, their completion state, and verification judgments remain deliberate governed inputs.
