    ...
    public static function infolist(Schema $schema): Schema
    {
        return $schema->components([
            ...
            Section::make('Staff closure')->schema([
                ...
                TextEntry::make('closure.delivery.notification_id')->label('In-app notification ID')->columnSpanFull(),
                TextEntry::make('closure.delivery.channel')->label('Delivery channel'),
