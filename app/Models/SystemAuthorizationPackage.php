...
class SystemAuthorizationPackage extends Model
{
    ...
    protected $fillable = ['application_id', 'version', 'application_snapshot', 'system_boundary', 'impact_level', 'data_classifications', 'control_snapshot', 'risk_snapshot', 'open_findings', 'monitoring_strategy', 'poam_reference', 'change_summary', 'submitted_by', 'submitted_at', 'fingerprint'];

    protected $casts = ['version' => 'integer', 'application_snapshot' => 'array', 'data_classifications' => 'array', 'control_snapshot' => 'array', 'risk_snapshot' => 'array', 'open_findings' => 'array', 'submitted_at' => 'datetime'];

    protected $appends = ['authorization_state'];
