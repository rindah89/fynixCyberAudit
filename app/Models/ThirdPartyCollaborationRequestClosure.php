...
class ThirdPartyCollaborationRequestClosure extends Model
{
    ...
    protected $fillable = ['third_party_engagement_collaboration_request_id', 'accepted_event_id', 'request_snapshot', 'accepted_event_snapshot', 'recipient_context', 'due_context', 'escalation_snapshot', 'summary', 'closed_by', 'actor_snapshot', 'closed_at', 'fingerprint'];

    protected $casts = ['request_snapshot' => 'array', 'accepted_event_snapshot' => 'array', 'recipient_context' => 'array', 'due_context' => 'array', 'escalation_snapshot' => 'array', 'actor_snapshot' => 'array', 'closed_at' => 'datetime'];
