...
class PolicyExceptionMonitoringReviewEvidence extends Model
{
    protected $table = 'policy_exception_monitoring_review_evidence';
    ...
    {
        static::updating(fn () => throw new LogicException('Policy exception monitoring evidence is append-only through product interfaces.'));
        static::deleting(fn () => throw new LogicException('Policy exception monitoring evidence is append-only through product interfaces.'));
    }
