...
class FileAttachment extends Model
{
    ...
    public function policyExceptionMonitoringEvidence(): HasMany
    {
    ...
    public function recoveryExerciseEvidence(): HasMany
    {
    ...
    public function riskGovernanceReviewEvidence(): HasMany
    {
    ...
    public function auditProcedureExecutionEvidence(): HasMany
    {
    ...
    public function hasGovernedEvidenceReferences(): bool
    {
        return $this->closureEvidence()->exists()
            ...
            || $this->policyExceptionMonitoringEvidence()->exists()
