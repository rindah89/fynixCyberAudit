...
<div class="space-y-5 text-sm" style="color: var(--gray-700);">
    ...
    @foreach (['audit_snapshot' => 'Audit snapshot', 'engagement_baseline_snapshot' => 'Engagement baseline snapshot', 'audit_item_snapshots' => 'Audit item snapshots', 'data_request_snapshots' => 'Data request snapshots', 'audit_procedure_snapshots' => 'Audit procedure snapshots'] as $field => $label)
