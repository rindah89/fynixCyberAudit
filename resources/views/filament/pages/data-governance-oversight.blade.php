                ...
                <div class="rounded-xl border p-4" style="border-color: var(--border, #DADAD4); background: var(--surface, #fff);">
                    ...
                    <div class="mt-4 border-t pt-4" style="border-color: var(--border, #DADAD4);">
                        ...
                        <dl class="mt-3 grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div><dt style="color: var(--ink-muted, #5B5B56);">Retention-run review</dt><dd class="font-medium {{ $coverage['operability']['pending_retention_run_reviews'] > 0 ? 'text-amber-700' : '' }}">{{ $coverage['operability']['pending_retention_run_reviews'] }} pending</dd></div>
