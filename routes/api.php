...
use App\Http\Controllers\API\EsgManagementController;
...
use App\Http\Controllers\API\ModelRiskController;
...
use App\Http\Controllers\API\SystemAuthorizationController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/compliance-cases/{complianceCase}/events', [ComplianceCaseController::class, 'events']);
    Route::post('/compliance-cases/{complianceCase}/events', [ComplianceCaseController::class, 'record']);
    ...
    Route::put('/privacy-processing-activities/{activity}', [PrivacyManagementController::class, 'revise']);
    Route::get('/privacy-processing-activities/{activity}/versions', [PrivacyManagementController::class, 'versions']);
    Route::get('/privacy-processing-activities/{activity}/assessments', [PrivacyManagementController::class, 'assessments']);
    Route::post('/privacy-processing-activities/{activity}/assessments', [PrivacyManagementController::class, 'assess']);
    Route::get('/governed-models', [ModelRiskController::class, 'index']);
    Route::post('/governed-models', [ModelRiskController::class, 'store']);
    Route::get('/governed-models/{governedModel}', [ModelRiskController::class, 'show']);
    Route::put('/governed-models/{governedModel}', [ModelRiskController::class, 'revise']);
    Route::get('/governed-models/{governedModel}/versions', [ModelRiskController::class, 'versions']);
    Route::get('/governed-models/{governedModel}/validations', [ModelRiskController::class, 'validations']);
    Route::post('/governed-models/{governedModel}/validations', [ModelRiskController::class, 'validateModel']);
    ...
    Route::get('/incidents/{incident}/notifications', [IncidentGovernanceController::class, 'notifications']);
    Route::post('/incidents/{incident}/notifications', [IncidentGovernanceController::class, 'storeNotification']);
    Route::post('/incident-notifications/{notification}/decisions', [IncidentGovernanceController::class, 'notificationDecision']);
    Route::get('/incident-notifications/{notification}/events', [IncidentGovernanceController::class, 'notificationEvents']);
    ...
    Route::get('/incidents/{incident}/final-reports', [IncidentGovernanceController::class, 'finalReports']);
    Route::post('/incidents/{incident}/final-reports', [IncidentGovernanceController::class, 'generateFinalReport']);
    ...
    Route::get('/system-authorization-packages', [SystemAuthorizationController::class, 'index']);
    Route::post('/applications/{application}/authorization-packages', [SystemAuthorizationController::class, 'store']);
    ...
    Route::get('/esg-material-topics', [EsgManagementController::class, 'index']);
    Route::post('/esg-material-topics', [EsgManagementController::class, 'store']);
    Route::get('/esg-material-topics/{topic}', [EsgManagementController::class, 'show']);
    Route::put('/esg-material-topics/{topic}', [EsgManagementController::class, 'revise']);
