...
class PrivacyManagementTest extends TestCase
{
    ...
    public function test_governed_activity_versions_and_independent_assessment_are_reconstructible(): void
    {
        ...
        $service->revise($manager, $activity->refresh(), array_merge($this->activityData($owner), ['status' => PrivacyActivityStatus::Active->value, 'change_summary' => 'Activate after independent approval.']));
